    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑文化产品收藏</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑文化产品收藏</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">文化产品收藏信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 wenhuachanpinCollectionTypesDiv">
                                        <label>类型</label>
                                        <select style="width: 450px" id="wenhuachanpinCollectionTypesSelect" name="wenhuachanpinCollectionTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    // 下拉框数组
        <!-- 当前表的下拉框数组 -->
    var wenhuachanpinCollectionTypesOptions = [];
        <!-- 级联表的下拉框数组 -->
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("wenhuachanpinCollection/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addwenhuachanpinCollection');
    ...
    // 查询列表
        ...
        function wenhuachanpinCollectionTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=wenhuachanpin_collection_types", "GET", {}, (res) => {
                if(res.code == 0){
                    wenhuachanpinCollectionTypesOptions = res.data.list;
                }
            });
        }
        <!-- 查询级联表的所有列表 -->
    ...
    // 初始化下拉框
    <!-- 初始化当前表的下拉框 -->
        function initializationWenhuachanpincollectiontypesSelect(){
            var wenhuachanpinCollectionTypesSelect = document.getElementById('wenhuachanpinCollectionTypesSelect');
            if(wenhuachanpinCollectionTypesSelect != null && wenhuachanpinCollectionTypesOptions != null  && wenhuachanpinCollectionTypesOptions.length > 0 ){
                for (var i = 0; i < wenhuachanpinCollectionTypesOptions.length; i++) {
                    wenhuachanpinCollectionTypesSelect.add(new Option(wenhuachanpinCollectionTypesOptions[i].indexName,wenhuachanpinCollectionTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(wenhuachanpinCollectionTypesSelect != null && wenhuachanpinCollectionTypesOptions != null  && wenhuachanpinCollectionTypesOptions.length > 0 ) {
            for (var i = 0; i < wenhuachanpinCollectionTypesOptions.length; i++) {
                if (wenhuachanpinCollectionTypesOptions[i].codeIndex == ruleForm.wenhuachanpinCollectionTypes) {//下拉框value对比,如果一致就赋值汉字
                        wenhuachanpinCollectionTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                yonghuId: "required",
                wenhuachanpinCollectionTypes: "required",
            },
            messages: {
                wenhuachanpinId: "文化产品不能为空",
                yonghuId: "用户不能为空",
                wenhuachanpinCollectionTypes: "类型不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addwenhuachanpinCollection = window.sessionStorage.getItem("addwenhuachanpinCollection");
        if (addwenhuachanpinCollection != null && addwenhuachanpinCollection != "" && addwenhuachanpinCollection != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("wenhuachanpinCollection/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            <!--  初始化当前表的下拉框  -->
            initializationWenhuachanpincollectiontypesSelect();
            <!--  初始化级联表的下拉框  -->
