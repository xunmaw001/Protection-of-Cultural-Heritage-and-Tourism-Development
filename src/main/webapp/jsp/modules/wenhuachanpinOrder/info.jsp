            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">文化产品订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wenhuachanpinOrderUuidNumber" name="wenhuachanpinOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.wenhuachanpinOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wenhuachanpinOrderTruePrice" name="wenhuachanpinOrderTruePrice" class="form-control"
                                               v-model="ruleForm.wenhuachanpinOrderTruePrice" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wenhuachanpinOrderCourierName" name="wenhuachanpinOrderCourierName" class="form-control"
                                               v-model="ruleForm.wenhuachanpinOrderCourierName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wenhuachanpinOrderCourierNumber" name="wenhuachanpinOrderCourierNumber" class="form-control"
                                               v-model="ruleForm.wenhuachanpinOrderCourierNumber" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="wenhuachanpinOrderValue" name="wenhuachanpinOrderValue" class="form-control"
                                           v-model="ruleForm.wenhuachanpinOrderValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="wenhuachanpinOrderPaymentValue" name="wenhuachanpinOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.wenhuachanpinOrderPaymentValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "wenhuachanpinOrder/info/" + id,
