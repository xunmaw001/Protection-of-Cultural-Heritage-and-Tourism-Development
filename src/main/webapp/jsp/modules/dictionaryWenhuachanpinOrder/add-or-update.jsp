...
<script>
    ...
    var tableName = "dictionaryWenhuachanpinOrder";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "wenhuachanpin_order_types";
            data["dicName"] = "订单类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"wenhuachanpin_order_types"}, (res) => {
                if(res.code == 0){
