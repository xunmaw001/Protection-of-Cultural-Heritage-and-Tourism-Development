                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 jingdianOldMoneyDiv">
                                        <label>景点原价</label>
                                        <input style="width: 450px" id="jingdianOldMoney" name="jingdianOldMoney" class="form-control"
                                               onchange="jingdianOldMoneyChickValue(this)" placeholder="景点原价">
                                    </div>
                                    <div class="form-group col-md-6 jingdianNewMoneyDiv">
                                        <label>现价</label>
                                        <input style="width: 450px" id="jingdianNewMoney" name="jingdianNewMoney" class="form-control"
                                               onchange="jingdianNewMoneyChickValue(this)" placeholder="现价">
                                    </div>
...
<script>
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function jingdianOldMoneyChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                // jingdianOldMoney: "景点原价不能为空",
                // jingdianNewMoney: "现价不能为空",
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            // 景点原价设置不可选
            $('#jingdianOldMoney').attr('readonly', 'readonly');
            // 现价设置不可选
