            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="project-sec pt-100 pb-70">
                        <div class="row">
                            <div v-for="(item,index) in jingdianList" v-bind:key="index" class="col-md-3 col-sm-6">
                                <div class="item" @click="jumpCheck('../jingdian/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="project-thumb">
                                        <img :src="item.jingdianPhoto?item.jingdianPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="project-hoverlay">
                                            <div class="project-text">
                                                <h3 v-if="item.jingdianNewMoney">
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="project-sec pt-100 pb-70">
                        <div class="row">
                            <div v-for="(item,index) in wenhuachanpinList" v-bind:key="index" class="col-md-3 col-sm-6">
                                <div class="item" @click="jumpCheck('../wenhuachanpin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="project-thumb">
                                        <img :src="item.wenhuachanpinPhoto?item.wenhuachanpinPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="project-hoverlay">
                                            <div class="project-text">
                                                <h3 v-if="item.wenhuachanpinNewMoney">
                                                    {{item.wenhuachanpinNewMoney}} RMB
                                                </h3>
                                                <h3 v-else>
                                                    {{item.wenhuachanpinValue}}
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                    <h2>{{item.wenhuachanpinName}}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`wenhuachanpin/list`, 'get', {
            ...
            vue.wenhuachanpinList = res.data.list;
        });
    });
</script>
