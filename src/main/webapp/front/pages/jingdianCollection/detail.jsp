...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-details-wrapper">
                    <div><img :src="detail.jingdianCollectionPhoto" alt="image" style="width: 80%;height: auto" ></div>
                    <div class="blog-details-header">
                        <h3 class="blog-details-title">{{title}}</h3>
                        <ul class="post-meta">
                            <li v-if="detail.jingdianCollectionTypes">类型：
        ...
        <div class="col-lg-4" v-if="jingdianCollectionRecommendList">
            <div class="sidebar">
                ...
                <div class="widget">
                    ...
                    <ul class="small-post-list">
                        <li class="small-post-single" v-for="(item,index) in jingdianCollectionRecommendList" v-bind:key="index" @click="jump('../jingdianCollection/detail.jsp?id='+item.id)">
                            <div class="thumb"><img width="65px" :src="item.jingdianCollectionPhoto"  alt="image"></div>
                            <div class="content">
                                <a class="main_color" class="date">{{item.jingdianCollectionName}}</a>
                                <h6 v-if="item.jingdianCollectionNewMoney" class="post-title"><a style="color: red">{{item.jingdianCollectionNewMoney}}</a>RMB</h6>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    var vue = new Vue({
        ...
        data: {
            ...
            //系统推荐
            jingdianCollectionRecommendList: [],
            dataList: [],
            // 当前详情页表
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function (res) {
            // 详情信息
            vue.detail = res.data;
            vue.title = vue.detail.jingdianCollectionName;
           // 轮播图片
        ...
        http.request(`jingdianCollection/list`, 'get', {
            page: 1,
            limit: 5,
            jingdianCollectionTypes: vue.detail.jingdianCollectionTypes,




        }, function (res) {
            vue.jingdianCollectionRecommendList = res.data.list;
        });
