...
public class WenhuachanpinLiuyanView extends WenhuachanpinLiuyanEntity implements Serializable {
	...
	public WenhuachanpinLiuyanView() {

	}

	public WenhuachanpinLiuyanView(WenhuachanpinLiuyanEntity wenhuachanpinLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, wenhuachanpinLiuyanEntity);
