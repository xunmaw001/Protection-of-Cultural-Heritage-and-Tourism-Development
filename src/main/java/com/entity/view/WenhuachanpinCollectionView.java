 ...
 */
@TableName("wenhuachanpin_collection")
public class WenhuachanpinCollectionView extends WenhuachanpinCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String wenhuachanpinCollectionValue;
	...
	public WenhuachanpinCollectionView() {

	}

	public WenhuachanpinCollectionView(WenhuachanpinCollectionEntity wenhuachanpinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, wenhuachanpinCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getWenhuachanpinCollectionValue() {
				return wenhuachanpinCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setWenhuachanpinCollectionValue(String wenhuachanpinCollectionValue) {
				this.wenhuachanpinCollectionValue = wenhuachanpinCollectionValue;
			}
