    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                WenhuachanpinEntity wenhuachanpin = wenhuachanpinService.selectById(cart.getWenhuachanpinId());
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("wenhuachanpin_id", cart.getWenhuachanpinId())
...
//                            cartEntity.setWenhuachanpinId(Integer.valueOf(data.get(0)));   //文化产品 要改的
